package com.greatbee.core.manager.data.bean;
...
public class Condition {
    ...
    public List<com.greatbee.core.bean.view.Condition> getConditions() {
        return null;
    }
    ...
    public static void buildConditionSql(StringBuilder sql, com.greatbee.core.bean.view.Condition condition) {
        buildConditionSql(sql, condition, (String)null);
    }

    public static void buildConditionSql(StringBuilder sql, com.greatbee.core.bean.view.Condition condition, String tableAlias) {
        List conditions = condition.getConditions();
        if(conditions != null) {
            sql.append(" ( ");

            for(int vals = 0; vals < conditions.size(); ++vals) {
                com.greatbee.core.bean.view.Condition i = (com.greatbee.core.bean.view.Condition)conditions.get(vals);
                buildConditionSql(sql, i, tableAlias);
                if(vals < conditions.size() - 1) {
    ...
    public static int buildConditionSqlPs(int index, PreparedStatement ps, com.greatbee.core.bean.view.Condition condition) throws SQLException {
    ...
    public static void buildCriteriaCondition(Class beanClass, Criteria c, Junction junction, com.greatbee.core.bean.view.Condition condition) {
        if(condition != null) {
            List conditions = condition.getConditions();
            if(conditions != null) {
                Object junc = null;
                ...
                for(int i = 0; i < conditions.size(); ++i) {
                    com.greatbee.core.bean.view.Condition _condition = (com.greatbee.core.bean.view.Condition)conditions.get(i);
    ...
    private static Criterion _transferJunction(Class beanClass, com.greatbee.core.bean.view.Condition condition) {
    ...
    private static Object _getConditionValue(Class beanClass, com.greatbee.core.bean.view.Condition condition) {
